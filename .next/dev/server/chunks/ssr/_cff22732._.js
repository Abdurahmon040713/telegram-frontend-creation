...
function LoginForm() {
    ...
    const codeInputDebounce = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
            ...
            if (response?.status === "waiting_for_code") {
                ...
                try {
                    if (response?.token || response?.access_token) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set('telegram_token', token, {
                            expires: 7,
                            secure: true,
                            sameSite: 'lax',
                            path: '/'
                        });
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set('telegram_phone', phone, {
                            expires: 7,
                            secure: true,
                            sameSite: 'lax',
                            path: '/'
    ...
    const handleVerify = async (e)=>{
        ...
        try {
            ...
            setCode(verifyCode);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].verify({
                phone: phone,
                code: verifyCode,
...
//# sourceMappingURL=_cff22732._.js.map